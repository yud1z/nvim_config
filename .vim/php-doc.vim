...
let g:pdv_cfg_Author = "Yudhistiara, Langi <yudis.net42@gmail.com>"
let g:pdv_cfg_Copyright = "Yud1z code Development"
...
func! PhpDocFunc()
	...
	let l:funcname = substitute (l:name, g:pdv_re_func, '@function \2', "g")
	...
	exe l:txtBOL . g:pdv_cfg_Comment1 . "@abstract description" . " " . g:pdv_cfg_EOL
...
func! PhpDocClass()
	...
	let l:classname = substitute (l:name, g:pdv_re_class, '@class \3', "g")
